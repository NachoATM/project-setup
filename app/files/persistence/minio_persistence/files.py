...
import uuid
from files.domain.persistence.files_persistence import FilesPersistenceServiceInterface
from typing import Union
from minio import Minio


class FilesMinioPersistenceService(FilesPersistenceServiceInterface):
    def __init__(self):
